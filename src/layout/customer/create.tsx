...
const CreateCustomer = () => {
    ...
    return (
        <div style={{ padding: 20 }}>
            <p className='title-create'>Thêm khách thuê phòng</p>
                    ...
                    >
                        ...
                        <Row>
                            <Col span={8} offset={2}>
                                ...
                                >
                                    <Input className='input-create' autoFocus />
                                </Form.Item>
                            </Col>
                            <Col span={8} offset={2}>
                                <Form.Item
                        ...
                        <Row>
                            <Col span={8} offset={2}>
                                <Form.Item
                                    ...
                                    labelAlign='left'
                                >
                                    <DatePicker className='input-create' />
                                </Form.Item>
                            </Col>
                            <Col span={8} offset={2}>
                                <Form.Item
                        ...
                        <Row>
                            <Col span={8} offset={2}>
                                <Form.Item
                                    ...
                                    validateTrigger={['onBlur', 'onChange']}
                                >
                                    <Input disabled className='input-create' />
                                </Form.Item>
                            </Col>
                            <Col span={8} offset={2}>
                                <Form.Item
